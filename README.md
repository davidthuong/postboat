...
| [docs/nguon.md](docs/nguon.md) | Nguồn này đòi chuẩn bị những gì trước khi chạy được |
...
xem việc phải chuẩn bị cho từng nguồn.

Việc phải chuẩn bị thì khác nhau theo từng nhà cung cấp, và đó là chỗ tốn thời
gian nhất của cả cuộc migrate — Gmail đòi App Password, M365 đã tắt basic auth
từ lâu, Zimbra và cPanel lại có cái kẹt riêng. Toàn bộ nằm ở một chỗ:

**→ [docs/nguon.md](docs/nguon.md) — chuẩn bị phía nguồn, theo từng nhà cung cấp**

Ở đó có: Gmail / Google Workspace · Microsoft 365 / Exchange Online · [cái gì
của M365 không đi qua IMAP](docs/nguon.md#microsoft-365-cái-gì-không-đi-qua-imap)
· cPanel / DirectAdmin / Plesk (Dovecot), Courier · Zimbra · Yahoo / Zoho /
iCloud · nguồn không có trong danh sách · và [đăng nhập bằng tài khoản quản
trị](docs/nguon.md#đăng-nhập-bằng-tài-khoản-quản-trị-auth--master) để khỏi phải
xin mật khẩu từng người.
...
- `auth = master` nhận `dovecot`, `zimbra` và `imap` — xem
  [docs/nguon.md § đăng nhập bằng tài khoản quản trị](docs/nguon.md#đăng-nhập-bằng-tài-khoản-quản-trị-auth--master). Mới chỉ **Dovecot**
